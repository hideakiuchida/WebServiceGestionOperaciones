...
namespace Bonus.BusinessServices.WsBonusTipoCuenta {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="AppBonus", ConfigurationName="WsBonusTipoCuenta.wsmenafiSoapPort")]
    public interface wsmenafiSoapPort {
        ...
        Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteResponse Execute(Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="AppBonusaction/AWSMENAFI.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteResponse> ExecuteAsync(Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteRequest request);
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Bonus.BusinessServices.WsBonusTipoCuenta.LismenafiLismenafiItem[] Carritomen;
        ...
        public ExecuteResponse(short Coderror, string Msjerror, Bonus.BusinessServices.WsBonusTipoCuenta.LismenafiLismenafiItem[] Carritomen, sbyte Existeprs) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wsmenafiSoapPortChannel : Bonus.BusinessServices.WsBonusTipoCuenta.wsmenafiSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wsmenafiSoapPortClient : System.ServiceModel.ClientBase<Bonus.BusinessServices.WsBonusTipoCuenta.wsmenafiSoapPort>, Bonus.BusinessServices.WsBonusTipoCuenta.wsmenafiSoapPort {
        ...
        Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteResponse Bonus.BusinessServices.WsBonusTipoCuenta.wsmenafiSoapPort.Execute(Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public short Execute(short Cantidadcta, string Ctaprscod, short Ctacod, string Pctaasocod, string Pctatip, string Pctaautcnj, out string Msjerror, out Bonus.BusinessServices.WsBonusTipoCuenta.LismenafiLismenafiItem[] Carritomen, out sbyte Existeprs) {
            Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteRequest inValue = new Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteRequest();
            ...
            Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteResponse retVal = ((Bonus.BusinessServices.WsBonusTipoCuenta.wsmenafiSoapPort)(this)).Execute(inValue);
        ...
        public System.Threading.Tasks.Task<Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteResponse> ExecuteAsync(Bonus.BusinessServices.WsBonusTipoCuenta.ExecuteRequest request) {
